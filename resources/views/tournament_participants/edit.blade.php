@extends('layouts.app')
@section('title', 'Edit Peserta Turnamen')
@section('content')
<div class="pagetitle">
    <h1>Edit Peserta</h1>
    <nav>
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white">
        <h5 class="card-title mb-0 fw-bold text-navy">Form Edit Peserta Turnamen</h5>
    </div>
    <div class="card-body pt-3">
        <form action="{{ route('tournament_participants.update', $item->id) }}" method="POST">
            @csrf
            @method('PUT')
            @include('tournament_participants.form', ['item' => $item])
            <div class="mt-4">
